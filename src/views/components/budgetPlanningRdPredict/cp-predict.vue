  ...
  <div class="page-container">
    <div class="page-container-A">
      <div class="page-container-A-a">
        <a-form layout="inline" class="aform">
          <div class="w-paragraph-a">
            <a-form-item label="部门" style="margin-bottom: 42px; width: 950px" class="wp-a">
              <a-select
                placeholder="请选择部门"
                show-search
                style="width: 500px"
        ...
        <a-upload
          ...
          :multiple="true"
          action="/srv.download/import_list?project=iomc_budgetsrv&schema=budget_submit_cp"
          :headers="headers"
          @change="handleChangeCpp"
        >
    ...
    downloadfilecp() {
      ...
      if (this.judgedepart) {
        downLoadTemplatefile({
          custom: [
            { id: '数据类别', option: '2022年预测' },
            { id: '部门', default: this.departmentOption },
            { id: '关联COA产品', option: this.CoaproductOption },
            { id: '该阶段起始年月', default: '2022/01' },
            { id: '该阶段终止年月', default: '2022/12' }
          ],
          project: 'iomc_budgetsrv',
          schema: 'budget_submit_cp'
        }).then((res) => {
