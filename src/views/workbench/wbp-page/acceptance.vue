...
export default {
  name: 'WorkbenchWbpPageAcceptance',
  data() {
    return {
    }
  },
      ...
      return [
        {
          label: '待发起验收',
          value: 1,
          path: '/workbench/acceptance/by-acceptance',
          count: this.wbpVerifyCount.doingCout
        },
        {
          label: '待需求经办人验收',
          value: 2,
          path: '/workbench/acceptance/demand-acceptance',
          count: this.wbpVerifyCount.demandCount
        },
        {
          label: '待审批人验收',
          value: 3,
          path: '/workbench/acceptance/acceptance-approve',
          count: this.wbpVerifyCount.approveCount
        }
      ]
    },
